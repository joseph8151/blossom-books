...
// 영국 교과과정(Year 1–11, GCSE, A-level) 및 입학시험(11+, ISEB, UKiset)
// 문의에만 카카오톡으로 직접 전달하는 비공개 구성·가격표입니다. /quote-us와
// 같은 계열로, 홈 메뉴/헤더/푸터/사이트맵에는 연결하지 않고 검색 노출도
// 막아둡니다. 홈·교재 찾기 페이지의 "영국" 카드에서만 링크로 연결됩니다.
export const metadata = {
  title: "영국 교과·입학시험 구성·가격 안내",
  description: "카카오톡 상담에서 안내하는 영국 교과·입학시험 구성표입니다.",
  robots: { index: false, follow: false },
  alternates: { canonical: "https://www.blossombooks.org/quote-uk/" },
  openGraph: {
    title: "Blossom Books 영국 교과·입학시험 구성 안내",
    description: "카카오톡 상담에서 안내하는 영국 교과·입학시험 구성표입니다.",
...
export default function QuoteUkPage() {
  return (
    <div className="mx-auto max-w-[880px] px-5 py-14 lg:px-8 lg:py-20">
      ...
      <p className="mt-3 text-[14.5px] leading-relaxed text-charcoal-600">
        Year 1–11, GCSE, A-level, 11+, ISEB, UKiset. 문항만 다르고 분량 단가는 같습니다.
      </p>
      ...
      <p className="mt-6 text-[12.5px] leading-relaxed text-charcoal-600/80">
        학교 교과서 목차와 100% 같지 않을 수 있습니다. 단원 추가·삭제, 시험국(AQA, Edexcel, OCR)은 카카오톡으로
        알려주세요.
      </p>
