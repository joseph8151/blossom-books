...
// 호주 교과과정(Foundation–Year 12) 문의에만 카카오톡으로 직접 전달하는
// 비공개 구성·가격표입니다. /quote-us와 같은 계열로, 홈 메뉴/헤더/푸터/
// 사이트맵에는 연결하지 않고 검색 노출도 막아둡니다. 홈·교재 찾기 페이지의
// "호주" 카드에서만 링크로 연결됩니다.
export const metadata = {
  title: "호주 교과 구성·가격 안내",
  description: "카카오톡 상담에서 안내하는 호주 교과 구성표입니다.",
  robots: { index: false, follow: false },
  alternates: { canonical: "https://www.blossombooks.org/quote-au/" },
  openGraph: {
    title: "Blossom Books 호주 교과 구성 안내",
    description: "카카오톡 상담에서 안내하는 호주 교과 구성표입니다.",
...
export default function QuoteAuPage() {
  return (
    <div className="mx-auto max-w-[880px] px-5 py-14 lg:px-8 lg:py-20">
      ...
      <p className="mt-3 text-[14.5px] leading-relaxed text-charcoal-600">
        Foundation–Year 10 Australian Curriculum, Year 11–12 senior maths/English. 주(NSW, VIC, QLD, WA) 세부
        과목은 카카오톡으로 문의해 주세요.
      </p>
      <p className="mt-1.5 text-[13px] leading-relaxed text-charcoal-600/80">
        Australian Curriculum v9 기준으로 단원을 잡습니다. VCE / HSC / QCE 과목명은 카카오톡에 주 이름을
        주시면 맞춥니다.
      </p>
      ...
      <section className="mt-[72px]">
        ...
        <p className="mt-2.5 text-[12px] leading-relaxed text-charcoal-600/80">
          Year·과목마다 문항만 다릅니다. 분량 단가는 같습니다.
        </p>
      ...
      <section className="mt-[72px] rounded-xl bg-navy-950 p-7 shadow-[0_20px_44px_-28px_rgba(13,22,38,0.45)] sm:p-9">
        ...
        <p className="mt-1.5 text-[12px] text-ivory-100/60">Year·과목 1개 기준</p>
      ...
      <p className="mt-6 text-[12.5px] leading-relaxed text-charcoal-600/80">
        학교 교과서 목차와 100% 같지 않을 수 있습니다. 단원 추가·삭제, 주 이름(NSW, VIC, QLD, WA)은
        카카오톡으로 알려주세요.
      </p>
