...
const faqs = [
  ...
  },
  {
    ...
    a: "60P(Complete Prep)는 주요 유형을 균형 있게 연습하는 충분한 실전 대비 구성이고, 100P(Intensive Prep)는 난이도 확장과 유형별 집중 반복까지 담은 심화 구성입니다. 각 교재 상세페이지의 ‘구성 비교’ 표에서 어떤 학습이 포함되는지 나란히 확인하실 수 있습니다.",
  },
  {
