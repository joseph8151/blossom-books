...
const faqs = [
  ...
  },
  {
    ...
    a: "정답이 정해져 있지 않습니다. 시험까지 남은 기간과 현재 실력에 따라 달라지며, 더 많은 페이지가 항상 더 좋은 선택은 아닙니다. 시험이 가깝다면 100P(핵심 유형), 표준 대비는 200P, 충분한 반복·심화가 필요하면 300P를 권장합니다. ‘내게 맞는 교재 찾기’에서 몇 가지만 선택하면 적합한 구성을 추천해 드립니다.",
  },
  {
    q: "200페이지와 300페이지의 차이는 무엇인가요?",
    a: "200P(Complete Prep)는 주요 유형을 균형 있게 연습하는 충분한 실전 대비 구성이고, 300P(Intensive Prep)는 난이도 확장과 유형별 집중 반복까지 담은 심화 구성입니다. 각 교재 상세페이지의 ‘구성 비교’ 표에서 어떤 학습이 포함되는지 나란히 확인하실 수 있습니다.",
  },
  {
    q: "400페이지(이상)는 어떤 학생에게 추천하나요?",
    a: "장기 집중 준비가 필요하거나, 여러 영역의 반복 실전 연습·고난도 문제까지 준비하려는 학생에게 적합합니다. 300P를 초과하는 대형 구성·추가 영역·특수 시험은 별도 견적으로 안내해 드립니다.",
  },
  {
    q: "구매 전에 샘플을 볼 수 있나요?",
  ...
  {
    q: "가격은 어떻게 확인하나요?",
    a: "가격은 교재 구성에 따라 달라지며, 100페이지 구성부터 시작합니다. 시험·학년·과목·분량을 확인하신 뒤 각 교재 상세페이지에서 정확한 금액을 명확히 확인하실 수 있고, 결제 전 최종 금액을 모두 확인하실 수 있습니다. 300P 초과·추가 영역·특수 구성 등 일부는 별도 견적으로 안내됩니다.",
  },
  {
